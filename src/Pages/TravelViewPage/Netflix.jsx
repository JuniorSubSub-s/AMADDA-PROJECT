...
import "../../ui/TravelViewPage/style5.css";
    ...
    <div>
      ...
      <div className="travel-view-page">
        <Container className="main">
          <div className="main-background5">
            <div
              className="main-photo"
              style={{
                backgroundImage: `url(${process.env.PUBLIC_URL}/img/TravelViewPageImg/netflix.png)`,
              }}
            />
            <div className="main-textcontent">
              <div className="emphasis">흑백 요리사 쉐프들의 맛</div>
              <div className="p">넷플릭스 '흑백요리사' 쉐프의 가게에 대한 솔직 담백 일기</div>
            </div>
          </div>
