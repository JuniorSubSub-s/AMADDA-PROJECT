        ...
        <Container className="main">
          <div className="main-background6">
            <div
              ...
              style={{
                backgroundImage: `url(${process.env.PUBLIC_URL}/img/TravelViewPageImg/camping.png)`,
              }}
            />
            <div className="main-textcontent">
              <div className="emphasis">바람 솔솔~ 글램핑 & 캠핑</div>
              <div className="p">프로 캠핑러의 맛 레시피를 담은 일기 개봉!</div>
            </div>
          </div>
