...
import "../../ui/TravelViewPage/style.css";
      ...
      <Container className="main">
          <div className="main-background">    {/* 배경색 변경 */}
                ...
                <div  className="main-photo"
                      style={{
                        backgroundImage: `url(${process.env.PUBLIC_URL}/img/TravelViewPageImg/fall.png)`,
                      }}/>     

            <div className="main-textcontent">
                <div className="emphasis">가을 낭만 가득한 국내 맛집 추천</div> 
                <div className="p">영주, 경주, 강릉, 남이섬, 춘천</div> 
            </div>  
          </div>
