...
import "../../ui/TravelViewPage/style2.css";
import Footer from "../Foorter/Footer";
import Header from "../Header/MainHeader";


export const SaveMoneyPage = () => {
        ...
        <Container className="main">
          <div className="main-background2">
            <div
              ...
              style={{
                backgroundImage: `url(${process.env.PUBLIC_URL}/img/TravelViewPageImg/saveMoney.png)`,
              }}
            />
            <div className="main-textcontent">
              <div className="emphasis">프로 맛집러라면 가성비를 따져</div>
              <div className="p">국내 가성비 맛집이 한눈에</div>
            </div>
          </div>
