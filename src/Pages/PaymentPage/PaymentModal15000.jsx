        ...
        <div className="payment-method-overlay">
            <div className="payment-method-modal-container">
                ...
                <div className="payment-product-info">
                    <img src="/img/CoinImg/more_coin.png" alt="Product" className="payment-product-image" />
                    <div style={{ marginBottom: "5px", fontFamily: "font-notosansKR-medium" }}>300 AMC</div>
                    <div style={{ marginBottom: "30px", fontFamily: "font-notosansKR-medium" }}>금액: ₩15,000</div>
                </div>
